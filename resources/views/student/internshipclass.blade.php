        ...
        <section class="flex flex-col lg:flex-row lg:space-x-8">
            ...
            <div class="lg:w-3/4">
                @forelse ($internshipClasses as $internshipClass)
                    <!-- Infer progress based on status -->
                    @php
                        $status = strtolower($internshipClass->status);
                        $progress = ($status == 'ended') ? 100 : ($status == 'ongoing' ? 50 : 0);
                        $displayStatus = ($status == 'ended') ? 'completed' : ($status == 'ongoing' || $status == 'upcoming' ? 'active' : 'cancelled');
                    @endphp
                    ...
                    <div class="bg-white dark:bg-gray-800 bg-opacity-90 dark:bg-opacity-20 backdrop-blur-lg rounded-2xl shadow-xl p-6 mb-8 border border-gray-100 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-500 transition-all duration-300 group transform hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            ...
                            <div class="flex-1">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-600 dark:text-gray-300">
                                            ...
                                            <span class="inline-block px-3 py-1 text-sm font-semibold rounded-full animate__animated animate__pulse animate__infinite
                                                {{ $displayStatus == 'active' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200' }}">
                                ...
                                <div class="mt-6">
                                    ...
                                    @if ($internshipClass->recording)
                                        <a href="{{ $internshipClass->recording->link }}" target="_blank" class="text-indigo-500 hover:underline">
                            ...
                            <div class="mt-6 md:mt-0 md:ml-8">
                                <a href="{{ route('student.internship.class', $internshipClass) }}"
...
<style>
    ...
    @keyframes progress {
        ...
        to { stroke-dasharray: {{ $progress ?? 0 }}, 100; }
    }
    .animate-progress {
