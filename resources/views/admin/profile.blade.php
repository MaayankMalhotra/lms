...
<div class="px-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 flex items-center space-x-4">
                <div class="w-16 h-16 flex items-center justify-center bg-blue-100 rounded-full">
                    <img src="https://cdn-icons-png.flaticon.com/128/3135/3135755.png" alt="Joined On" class="w-10 h-10">
                </div>
                <div>
                    <h3 class="text-2xl font-bold text-gray-700">{{ $user->created_at->format('d M Y') }}</h3>
                    <p class="text-gray-500">Joined On</p>
                </div>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 flex items-center space-x-4">
                <div class="w-16 h-16 flex items-center justify-center bg-yellow-100 rounded-full">
                    <img src="https://cdn-icons-png.flaticon.com/128/2921/2921222.png" alt="Role" class="w-10 h-10">
                </div>
                <div>
                    <h3 class="text-2xl font-bold text-gray-700">{{ $user->role }}</h3>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 flex items-center space-x-4">
                <div class="w-16 h-16 flex items-center justify-center bg-red-100 rounded-full">
                    <img src="https://cdn-icons-png.flaticon.com/128/3135/3135773.png" alt="Qualification" class="w-10 h-10">
                </div>
                <div>
                    <h3 class="text-2xl font-bold text-gray-700">{{ $user->qualification }}</h3>
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Activity Overview (Static Chart) -->
        <div class="bg-white shadow-lg rounded-lg p-6">
            <h3 class="text-2xl font-bold text-gray-700 mb-4">Activity Overview</h3>
            <canvas id="performanceChart" class="w-full h-96"></canvas>
        </div>

        <!-- Calendar Section with User Info -->
        <div class="bg-white shadow-lg rounded-lg p-6 w-full">
            <h3 class="text-2xl font-bold text-gray-700 mb-4">June 2025</h3>
            <!-- Calendar Grid -->
            ...
            <div class="mt-6 bg-gray-100 p-4 rounded-lg shadow">
                <p class="text-gray-600"><strong>College/Company:</strong> {{ $user->college_company }}</p>
    ...
    <section class="bg-white p-6 rounded-lg shadow-md mt-5">
        ...
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-bold text-gray-700">User Details</h3>
            <a href="{{ route('profile') }}" class="text-orange-500 text-sm font-semibold hover:underline">Edit Profile</a>
        </div>
        <!-- User Details List -->
        <div class="space-y-4">
            <!-- Name -->
            <div class="flex items-center bg-gray-100 rounded-lg p-4 shadow">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" alt="Name" class="w-10 h-10 mr-4">
                <div>
            ...
            <!-- Phone -->
            <div class="flex items-center bg-gray-100 rounded-lg p-4 shadow">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" alt="Phone" class="w-10 h-10 mr-4">
                <div>
            ...
            <!-- Email -->
            <div class="flex items-center bg-gray-100 rounded-lg p-4 shadow">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cplusplus/cplusplus-original.svg" alt="Email" class="w-10 h-10 mr-4">
                <div>
...
<script>
    ...
    function generateCalendar(year, month) {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            // Highlight current day (June 4, 2025)
            if (year === 2025 && month === 5 && day === 4) {
                dayCell.classList.add("bg-purple-500", "text-white");
            }
    ...
    generateCalendar(2025, 5); // Note: Months are 0-indexed (5 = June)
</script>
@endsection