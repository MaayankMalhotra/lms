    ...
    <div class="max-w-6xl mx-auto bg-white rounded-xl shadow-lg p-6">
        ...
        <form action="{{ route('admin.job-roles.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="technologies" id="technologies" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('technologies') border-red-500 @enderror">{{ old('technologies') }}</textarea>
