    ...
    <div class="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800 flex items-center">
                <i class="fas fa-folder-plus mr-2"></i> Create News Category
            </h1>
            <p class="text-gray-500 mt-2">Add a new category for organizing news articles.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <form action="{{ route('admin.news-categories.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                <!-- Name -->
                <div>
