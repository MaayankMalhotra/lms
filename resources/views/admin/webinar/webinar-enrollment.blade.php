            ...
            <div id="confirmation-modal"
                ...
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    ...
                    <form id="confirmation-form">
                        ...
                        <div class="mb-4">
                            <label for="attendance-code" class="block text-sm font-medium text-gray-700">Attendance
                                Verification Code</label>
                            <input type="text" id="attendance-code" name="attendance_code"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="meeting-id" name="meeting_id"
                                class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                        ...
                        <div class="mb-4">
                            <label for="meeting-password" class="block text-sm font-medium text-gray-700">Meeting
                                Password</label>
                            <input type="text" id="meeting-password" name="meeting_password"
                                class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                        ...
                        <div class="flex justify-end space-x-2">
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg">Send</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <select name="webinar_id"
                            ...
                            @foreach ($webinars as $webinar)
                                <option value="{{ $webinar->id }}"
                                    {{ request('webinar_id') == $webinar->id ? 'selected' : '' }}>
                        ...
                        @forelse($enrollments as $enrollment)
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    ...
                                    @else
                                        @if ($enrollment->attendance_status === 'present')
                                            <form action="{{ route('admin.webinar.send-certificate', $enrollment->id) }}"
                                                method="POST">
                                                @csrf
                                                <button type="submit"
                ...
                fetch('{{ route('admin.webinar.send-confirmation') }}', {
                    ...
                    .then(text => {
                        ...
                        try {
                            ...
                            alert(data.message ||
                                'Confirmation emails sent and data saved successfully!');
                            modal.classList.add('hidden');
                        } catch (error) {
