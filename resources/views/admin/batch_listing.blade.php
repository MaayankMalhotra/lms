                    ...
                    <table class="" id="batchTable">
                        <thead>
                            <tr class="bg-gray-100">
                                ...
                                <th class="px-4 py-2 text-left text-sm font-medium text-gray-700">Slots (Available/Filled)
                                </th>
                        ...
                        <tbody>
                            @foreach ($batches as $batch)
                                <tr class="border-b">
                                    ...
                                    <td class="px-4 py-2 text-sm text-gray-600">{{ $batch->slots_available }} /
                                        {{ $batch->slots_filled }}</td>
                    ...
                    if (data.success) {
                        ...
                        if (row) {
                            ...
                            row.cells[7].textContent =
                                `${formData.get('slots_available')} / ${formData.get('slots_filled')}`;
