            ...
            <div class="flex flex-wrap -mx-2">
                ...
                <div class="w-full md:w-1/2 px-2 fade-up">
                    <div class="glass-card bg-gray-50 rounded-lg shadow-lg p-6 mb-8">
                        ...
                        @if (session('success'))
                            <div id="successMessage" class="mb-4 p-3 rounded bg-green-100 text-green-800 border border-green-300">
                                {{ session('success') }}
                            </div>
                            <script>
                                setTimeout(() => {
                                    ...
                                    if (successEl) {
                                        ...
                                        setTimeout(() => successEl.remove(), 500); // remove after fade-out
                                    }
                                }, 3000); // 3 seconds
                            </script>
                        @endif
                        <form action="{{ route('contact.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="user_type" id="userType"
                                    ...
                                    <option value="student" {{ old('user_type') === 'student' ? 'selected' : '' }}>Student
                                    </option>
                            ...
                            <!-- Contact Number -->
                            <div class="mb-4">
                                <label for="contactNumber" class="block mb-1 font-semibold text-gray-800">Contact
                                    Number</label>
                            ...
                            <!-- Email Address -->
                            <div class="mb-4">
                                <label for="emailAddress" class="block mb-1 font-semibold text-gray-800">Email
                                    Address</label>
                            ...
                            <!-- Student Fields -->
                            <div id="studentFields" class="{{ old('user_type') === 'student' ? '' : 'hidden' }}">
                                <div class="mb-4">
                                    <label for="graduationYear" class="block mb-1 font-semibold text-gray-800">Graduation
                                        Year</label>
                                    <input type="text" name="graduation_year" value="{{ old('graduation_year') }}"
                                        class="w-full px-3 py-2 rounded border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        id="graduationYear" placeholder="e.g. 2025">
                                </div>
                                <div class="mb-4">
                                    <label for="department"
                                        class="block mb-1 font-semibold text-gray-800">Department</label>
                                    <input type="text" name="department" value="{{ old('department') }}"
                                        class="w-full px-3 py-2 rounded border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        id="department" placeholder="e.g. Computer Science">
                                </div>
                            </div>

                            <!-- Employee Fields -->
                            <div id="employeeFields" class="{{ old('user_type') === 'employee' ? '' : 'hidden' }}">
                                <div class="mb-4">
                                    <label for="companyName" class="block mb-1 font-semibold text-gray-800">Company
                                        Name</label>
                            ...
                            <!-- Additional Comments -->
                            <div class="mb-4">
                                <label for="additionalMessage" class="block mb-1 font-semibold text-gray-800">Additional
                                    Comments</label>
                                <textarea name="message"
                                    class="w-full px-3 py-2 rounded border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    id="additionalMessage" rows="3" placeholder="Let us know how we can help you...">{{ old('message') }}</textarea>
                            </div>
                ...
                <div class="w-full md:w-1/2 px-2 fade-up">
                    <div class="glass-card bg-gray-50 rounded-lg shadow-lg p-6">
                        ...
                        <p class="mt-3 text-sm text-gray-600">
                            ...
                            <a href="https://wa.me/1234567890" target="_blank" class="inline-flex items-center"
