<nav class="bg-gradient-to-r from-[#2c0b57] to-[#0c3c7c] shadow-xl fixed w-full z-50">
    <div class="container mx-auto px-4">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden lg:flex items-center space-x-8">
          ...
          <div class="relative group">
            <button id="dropdown-button-1" class="text-white hover:text-amber-400 flex items-center gap-1 transition-colors duration-300">
              What we offer <i class="fas fa-chevron-down text-sm"></i>
            </button>
            <div id="dropdown-menu-1" class="absolute hidden group-hover:block bg-black/90 rounded-lg p-2 min-w-[200px] mt-2">
          ...
          <!-- Dropdown 2 -->
          <div class="relative group">
            <button id="dropdown-button-2" class="text-white hover:text-amber-400 flex items-center gap-1 transition-colors duration-300">
              Update <i class="fas fa-chevron-down text-sm"></i>
            </button>
            <div id="dropdown-menu-2" class="absolute hidden group-hover:block bg-black/90 rounded-lg p-2 min-w-[200px] mt-2">
      ...
      <div id="mobile-menu" class="hidden lg:hidden flex flex-col space-y-4 p-4 bg-[#2c0b57]">
        ...
        <!-- Mobile Dropdown 1 -->
        <button id="mobile-dropdown-button-1" class="text-white hover:text-amber-400 flex items-center justify-between w-full">
          What we offer
          <svg id="mobile-dropdown-icon-1" class="w-4 h-4 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
        <div id="mobile-dropdown-menu-1" class="hidden pl-4">
          <a href="{{ route('website.course') }}" class="block px-4 py-2 text-white hover:bg-orange-500 rounded-md transition-colors">Courses</a>
          <a href="{{ route('website.internship_details') }}" class="block px-4 py-2 text-white hover:bg-orange-500 rounded-md transition-colors">Internships</a>
          <a href="{{ route('website.course_details') }}" class="block px-4 py-2 text-white hover:bg-orange-500 rounded-md transition-colors">Course Details</a>
        </div>
        ...
        <!-- Mobile Dropdown 2 -->
        <button id="mobile-dropdown-button-2" class="text-white hover:text-amber-400 flex items-center justify-between w-full">
          Update
          <svg id="mobile-dropdown-icon-2" class="w-4 h-4 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
        <div id="mobile-dropdown-menu-2" class="hidden pl-4">
          <a href="{{ route('website.events') }}" class="block px-4 py-2 text-white hover:bg-orange-500 rounded-md transition-colors">Event</a>
          <a href="{{ route('website.news')}}" class="block px-4 py-2 text-white hover:bg-orange-500 rounded-md transition-colors">News</a>
          <a href="{{ route('website.webinar')}}" class="block px-4 py-2 text-white hover:bg-orange-500 rounded-md transition-colors">Webinars</a>
        </div>
