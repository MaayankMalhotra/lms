    ...
    public function submitr(Request $request)
{
    ...
    try {
        ...
        // Database transaction for all creations
        DB::beginTransaction();
        ...
        try {
            ...
            // For redirect: return redirect()->route('login')->with('success', 'Registration successful! Please log in with your email and password: 123456');
